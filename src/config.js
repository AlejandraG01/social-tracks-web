...
export const MASTODON_AUTH_URL = `https://socialtracks.masto.host/oauth/authorize?scope=read&response_type=code&redirect_uri=http:%2F%2F3.131.0.107:3001%2Flogin_mastodon&client_id=${MASTODON_CLIENT_ID}`;
