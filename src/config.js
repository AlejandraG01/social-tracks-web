const apiUrl = {
  ...
  production: "http://social-tracks.tk:3000"
};
...
export let SPOTIFY_REDIRECT_URL = "http://social-tracks.tk:3001/login_spotify";
...
export const MASTODON_AUTH_URL = `https://socialtracks.masto.host/oauth/authorize?scope=read&response_type=code&redirect_uri=http:%2F%2Fsocial-tracks.tk:3001%2Flogin_mastodon&client_id=${MASTODON_CLIENT_ID}`;
